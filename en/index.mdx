---
description: "Welcome to the QSalud ecosystem — a unified healthcare platform designed for multiple user types: patients, insurers, clinicians, and administrators."
title: "General Access | QSalud Manual"
---

## Global Overview

**QSalud **is more than a platform — it’s the new digital infrastructure for healthcare. Building on the limitations of traditional health systems, QSalud brings together:
...
QSalud aligns with the main global trends described in leading reports on the future of digital health (2023–2025).
...
QSalud addresses these inefficiencies with an accessible, interoperable, and secure system that puts people at the center.
...
> “QSalud is not an app. It’s the new digital health infrastructure — global, secure, and ready to scale.”