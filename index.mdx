---
description: "Bienvenido/a al ecosistema Qsalud.com, el primer sistema de salud digital completamente interoperable, descentralizado y centrado en el usuario. Este apartado sirve como introducción general a la arquitectura, filosofía y alcance del proyecto Qsalud, y constituye el punto de partida para todos los perfiles de usuario: pacientes, aseguradoras, médicos y administradores."
title: "Acceso General | QSalud.com"
---

## Visión Global

\*\*QSalud \*\*es más que una plataforma: es la nueva infraestructura de la salud del siglo XXI. Diseñado para resolver las ineficiencias, sobrecargas y fragmentaciones de los sistemas sanitarios tradicionales, QSalud combina:
